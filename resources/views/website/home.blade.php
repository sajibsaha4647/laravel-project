...
<div id="mu-slider">
  <div class="mu-slide">
    ...
    <div class="mu-single-slide">
      <img src="{{asset('contents/website')}}/images/slider-img-1.jpg" alt="slider img">
    ...
    <!-- Start single slide  -->
    <div class="mu-single-slide">
      <img src="{{asset('contents/website')}}/images/slider-img-2.jpg" alt="slider img">
      <div class="mu-single-slide-content-area">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
    ...
    <!-- Start single slide  -->
    <div class="mu-single-slide">
      <img src="{{asset('contents/website')}}/images/slider-img-3.jpg" alt="slider img">
      <div class="mu-single-slide-content-area">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-about-left">
                  <img class="" src="{{asset('contents/website')}}/images/about-us.jpg" alt="img">
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="mu-testimonials-area">
            ...
            <div class="mu-testimonials-block">
              <ul class="mu-testimonial-slide">
                ...
                <li>
                  <img class="mu-rt-img" src="{{asset('contents/website')}}/images/traveler-1.jpg" alt="img">
                ...
                <li>
                  <img class="mu-rt-img" src="{{asset('contents/website')}}/images/traveler-2.jpg" alt="img">
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa</p>
                ...
                <li>
                  <img class="mu-rt-img" src="{{asset('contents/website')}}/images/traveler-3.jpg" alt="img">
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa</p>
          ...
          <div class="mu-clients-area">
            ...
            <div class="mu-clients-slider">
              ...
              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-1.jpg" alt="Brand Logo">
              </div>

              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-2.jpg" alt="Brand Logo">
              </div>

              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-3.jpg" alt="Brand Logo">
              </div>

              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-4.jpg" alt="Brand Logo">
              </div>

              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-5.jpg" alt="Brand Logo">
              </div>

              <div class="mu-clients-single">
                <img src="{{asset('contents/website')}}/images/client-brand-6.jpg" alt="Brand Logo">
              </div>
            </div>
